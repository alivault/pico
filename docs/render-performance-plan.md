...
- [ ] Ref-based mutation hooks
  - [ ] Refactor prompt mutation inputs away from broad render-time values where safe.
  - [ ] Refactor session mutation inputs away from broad render-time values where safe.
