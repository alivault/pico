...
/// Fold Vertical icon
internal enum LucideIcon_FoldVertical {
    
/// Fold Vertical icon path (combined)
...
/// Fold Vertical icon open subpaths
...
/// Fold Vertical icon closed subpaths
