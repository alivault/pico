...
internal enum LucideIcon_UnfoldHorizontal {
    
/// Unfold Horizontal icon path (combined)
...
/// Unfold Horizontal icon open subpaths
...
/// Unfold Horizontal icon closed subpaths
