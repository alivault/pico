...
internal enum LucideIcon_SquareDashedText {
    
/// Square Dashed Text icon path (combined)
...
/// Square Dashed Text icon open subpaths
...
/// Square Dashed Text icon closed subpaths
