...
path.addCurve(to: CGPoint(x: 3.9999999999999996, y: 20.0), control1: CGPoint(x: 2.0, y: 19.104569499661586), control2: CGPoint(x: 2.8954305003384126, y: 20.0))
path.closeSubpath()
path.move(to: CGPoint(x: 13.3, y: 14.3))
path.addLine(to: CGPoint(x: 15.0, y: 16.0))
path.move(to: CGPoint(x: 9.0, y: 12.5))
path.addCurve(to: CGPoint(x: 11.5, y: 15.0), control1: CGPoint(x: 9.0, y: 13.880711874576983), control2: CGPoint(x: 10.119288125423015, y: 15.0))
path.addCurve(to: CGPoint(x: 14.0, y: 12.5), control1: CGPoint(x: 12.880711874576983, y: 15.0), control2: CGPoint(x: 14.0, y: 13.880711874576985))
