...
internal enum LucideIcon_PersonStanding {
    
/// Person Standing icon path (combined)
...
/// Person Standing icon open subpaths
...
/// Person Standing icon closed subpaths
