...
/// Square Dashed icon
internal enum LucideIcon_SquareDashed {
    
/// Square Dashed icon path (combined)
...
/// Square Dashed icon open subpaths
...
/// Square Dashed icon closed subpaths
