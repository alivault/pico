...
/// Banknote Check icon
internal enum LucideIcon_BanknoteCheck {
    
/// Banknote Check icon path (combined)
static let combinedPath: Path = {
    var path = Path()
    path.move(to: CGPoint(x: 11.748, y: 18.0))
...
path.addLine(to: CGPoint(x: 22.0, y: 12.875))
...
/// Banknote Check icon open subpaths
...
/// Banknote Check icon closed subpaths
