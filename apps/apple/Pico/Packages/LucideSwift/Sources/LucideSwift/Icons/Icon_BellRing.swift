...
/// Bell Ring icon
internal enum LucideIcon_BellRing {
    
/// Bell Ring icon path (combined)
...
path.addCurve(to: CGPoint(x: 20.0, y: 2.0), control1: CGPoint(x: 22.0, y: 5.7), control2: CGPoint(x: 21.2, y: 3.7))
...
path.addCurve(to: CGPoint(x: 18.0, y: 8.0), control1: CGPoint(x: 19.41, y: 13.956), control2: CGPoint(x: 18.0, y: 12.499))
...
path.addCurve(to: CGPoint(x: 2.0, y: 8.0), control1: CGPoint(x: 2.8, y: 3.7), control2: CGPoint(x: 2.0, y: 5.7))
    return path
}()
/// Bell Ring icon open subpaths
...
/// Bell Ring icon closed subpaths
