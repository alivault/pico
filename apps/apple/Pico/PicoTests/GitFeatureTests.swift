...
struct GitFeatureTests {
  @Test func parsesCommitGraphMetadata() {
    let separator = "\u{1f}"
    let line =
      "* abc1234\t0123456789abcdef0123456789abcdef01234567\(separator)deadbeef cafe0000\(separator)Ali\(separator)2 hours ago\(separator)2026-06-30T18:00:00+00:00\(separator)Add Git tab\(separator)2 files changed, 10 insertions(+), 3 deletions(-)"
  ...
  @Test func abbreviatesParentFoldersForCompactDiffHeaders() {
    #expect(
      GitFormatting.abbreviatedParentPath("apps/apple/Pico/Pico.xcodeproj/project.pbxproj")
        == "a/a/P/P/project.pbxproj"
    )
  ...
  @Test func makesPathsWrappableAtFolderBoundaries() {
    #expect(
      GitFormatting.wrappablePath("apps/apple/Pico/App.swift")
        == "apps/\u{200B}apple/\u{200B}Pico/\u{200B}App.swift"
    )
  ...
  @Test func parsesShikiHighlightedHTMLIntoSegments() {
    let html =
      "<span class=\"line\"><span style=\"color:var(--sh-token-keyword)\">let</span> value = &lt;tag attr=&quot;x&quot;&gt;</span>"
