...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitiveSeparator
      ...
      className={cn(
        "relative flex w-px items-center justify-center bg-transparent before:absolute before:inset-y-0 before:left-1/2 before:w-[2px] before:-translate-x-1/2 after:absolute after:inset-y-0 after:left-1/2 after:w-3 after:-translate-x-1/2 focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:outline-hidden data-[orientation=vertical]:h-px data-[orientation=vertical]:w-full data-[orientation=vertical]:before:inset-x-0 data-[orientation=vertical]:before:top-1/2 data-[orientation=vertical]:before:h-[2px] data-[orientation=vertical]:before:w-full data-[orientation=vertical]:before:translate-x-0 data-[orientation=vertical]:before:-translate-y-1/2 data-[orientation=vertical]:after:inset-x-0 data-[orientation=vertical]:after:top-1/2 data-[orientation=vertical]:after:h-3 data-[orientation=vertical]:after:w-full data-[orientation=vertical]:after:translate-x-0 data-[orientation=vertical]:after:-translate-y-1/2 data-[separator=active]:before:bg-sidebar-border data-[separator=disabled]:before:bg-transparent data-[separator=focus]:before:bg-sidebar-border data-[separator=hover]:before:bg-sidebar-border [&[data-orientation=vertical]>div]:rotate-90",
        className
      )}
      {...props}
    >
